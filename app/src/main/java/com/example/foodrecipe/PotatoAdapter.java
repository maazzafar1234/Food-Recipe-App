...
public class PotatoAdapter extends ArrayAdapter {
    ...
    public PotatoAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,Potato1.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,Potato2.class);
                    context.startActivity(i);
                }
                if(position==2)
                {
                    Intent i = new Intent(context,Potato3.class);
                    context.startActivity(i);
                }
                if(position==3)
                {
                    Intent i = new Intent(context,Potato4.class);
                    context.startActivity(i);
                }
                if(position==4)
                {
                    Intent i = new Intent(context,Potato5.class);
                    context.startActivity(i);
                }
                if(position==5)
                {
                    Intent i = new Intent(context,Potato6.class);
                    context.startActivity(i);
                }
                if(position==6)
                {
                    Intent i = new Intent(context,Potato7.class);
                    context.startActivity(i);
                }
            }
        });
