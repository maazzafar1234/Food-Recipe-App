...
public class GarlicAdapter extends ArrayAdapter {
    ...
    public GarlicAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,Garlic1.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,Garlic2.class);
                    context.startActivity(i);
                }
                if(position==2)
                {
                    Intent i = new Intent(context,Garlic3.class);
                    context.startActivity(i);
                }
            }
        });
