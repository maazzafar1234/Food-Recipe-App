...
public class BitterMelonAdapter extends ArrayAdapter {
    ...
    public BitterMelonAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,BitterMelon1.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,BitterMelon2.class);
                    context.startActivity(i);
                }
                if(position==2)
                {
                    Intent i = new Intent(context,BitterMelon3.class);
                    context.startActivity(i);
                }
                if(position==3)
                {
                    Intent i = new Intent(context,BitterMelon4.class);
                    context.startActivity(i);
                }
                if(position==4)
                {
                    Intent i = new Intent(context,BitterMelon5.class);
                    context.startActivity(i);
                }
                if(position==5)
                {
                    Intent i = new Intent(context,BitterMelon6.class);
                    context.startActivity(i);
                }
            }
        });
