...
public class LadyFingerAdapter extends ArrayAdapter {
    ...
    public LadyFingerAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,LadyFinger1.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,LadyFinger2.class);
                    context.startActivity(i);
                }
                if(position==2)
                {
                    Intent i = new Intent(context,LadyFinger3.class);
                    context.startActivity(i);
                }
                if(position==3)
                {
                    Intent i = new Intent(context,LadyFinger4.class);
                    context.startActivity(i);
                }
            }
        });
