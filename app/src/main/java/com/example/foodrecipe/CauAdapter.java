...
public class CauAdapter extends ArrayAdapter {
    ...
    public CauAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,Cauliflower1.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,Cauliflower2.class);
                    context.startActivity(i);
                }
                if(position==2)
                {
                    Intent i = new Intent(context,Cauliflower3.class);
                    context.startActivity(i);
                }
            }
        });
