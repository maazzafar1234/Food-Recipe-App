...
public class Sweets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LunchData[] myListData = new LunchData[] {
                ...
                new LunchData("Mysore Pak", R.drawable.mysorepak,"Recipe"),
                ...
                new LunchData("Shrikhand", R.drawable.shrikhnad,"Recipe")
        };
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.lunch)
        {
            Intent i = new Intent(Sweets.this,lunchRecipes.class);
            startActivity(i);
        }
        else if(id==R.id.dinner)
        {
            Intent i = new Intent(Sweets.this,Dinner.class);
            startActivity(i);
        }
        else if(id==R.id.breakfast)
        {
            Intent i = new Intent(Sweets.this,Breakfast.class);
            startActivity(i);
        }
        else if(id==R.id.fastfood)
        {
            Intent i = new Intent(Sweets.this,FastFood.class);
            startActivity(i);
        }
        else if(id==R.id.mexio)
        {
            Intent i = new Intent(Sweets.this,Mexicon.class);
            startActivity(i);
        }
