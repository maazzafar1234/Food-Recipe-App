...
public class CornAdapter extends ArrayAdapter {
    ...
    public CornAdapter(Activity context, Integer[] imageIDArrayParam, String[] nameArrayParam, String[] timeArrayParam , String[] btnArrayParam){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        buttonTextField.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position==0)
                {
                    Intent i = new Intent(context,CornNext.class);
                    context.startActivity(i);
                }
                if(position==1)
                {
                    Intent i = new Intent(context,CornNext2.class);
                    context.startActivity(i);
                }
            }
        });
